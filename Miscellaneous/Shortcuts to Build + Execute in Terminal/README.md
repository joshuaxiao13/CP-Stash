...
For Mac and Windows, you can customize these files to your liking with different [compiler flags](https://caiorss.github.io/C-Cpp-Notes/compiler-flags-options.html). 
