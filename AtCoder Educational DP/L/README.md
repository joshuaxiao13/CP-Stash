...
In this problem, Taro and Jiro take turns removing elements from the beginning or end of some sequence, `a`, until the sequence is empty. They add the value of the element they take to their score.
