...
In this problem, Taro and Jiro remove elements from the beginning or end of the a sequence `a` until the sequence is empty. They add the value of the element they take to their score.
